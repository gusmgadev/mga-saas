...
### 4. **Secciones Landing (Orden ACTUALIZADO - SIN CLIENTS)**
1. Navbar
2. Hero (idea visuaizada con gradiente)
3. Servicios (4 cards)
4. ZooLogic (Dragonfish, Lince, Pantera)
5. Proceso (timeline horizontal, 1 pantalla)
6. Por qué nosotros (diferenciales)
7. Testimonios (cases de éxito)
...
- ✅ Sección "Clients" removida (14/04/2026)
